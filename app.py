...
# --- जादुई एंटी-ब्लॉक सिस्टम (Yahoo को धोखा देने के लिए) ---
def get_safe_session():
    session = requests.Session()
    # Yahoo को लगेगा कि हम Windows कंप्यूटर पर Google Chrome चला रहे हैं
...
if st.session_state.app_mode == "📊 एडवांस एनालाइज़र (All-in-One)":
    ...
    if st.button("स्मार्ट 360° एनालिसिस करें"):
        with st.spinner(f"🚀 {selected_company} का डेटा सुरक्षित तरीके से लाया जा रहा है..."):
            try:
                # एंटी-ब्लॉक सेशन का इस्तेमाल
    ...
    if st.button(button_text):
        ...
        for i, (name, raw_ticker) in enumerate(stocks_to_scan):
            try:
                ...
                # Yahoo को शक न हो इसलिए हर स्कैन के बीच एक सेकंड का दसवां हिस्सा रुकना
                time.sleep(0.1)
            except:
                pass
